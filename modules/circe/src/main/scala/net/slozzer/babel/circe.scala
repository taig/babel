...
//
//  implicit val decoderText: Decoder[Quantities] = Decoder.instance { cursor =>
//    cursor.as[String].map(Quantities(_, Map.empty)).orElse {
//      for {
...
//  }
//
//  implicit val encoderText: Encoder[Quantities] = Encoder.instance { text =>
